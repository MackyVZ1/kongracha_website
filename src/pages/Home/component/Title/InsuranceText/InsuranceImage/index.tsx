  ...
  return (
    <>
      <svg
        ...
        viewBox='-3 0 19 19'
        className='max-w-[81px] max-h-[81px] w-[40px] h-[44px] drop-shadow-[0px_4px_4px] sm:hidden' // เปลี่ยนจาก w-21 h-21 เป็น w-20 h-20 (ค่าที่ Tailwind รองรับ)
      >
        <defs>
          {/* สร้าง gradient สำหรับ path */}
          <linearGradient
            id='insuranceGradient'
            x1='0%'
            y1='0%'
            x2='0%'
            y2='100%'
        ...
        <path
          fill='url(#insuranceGradient)' // ใช้ gradient แทน fill="#000000"
      ...
      <img
        src={insuranceImg}
        alt='insuranceImg'
        className='hidden sm:max-w-[64px] sm:max-h-[64px] sm:flex sm:bg-gradient-to-b sm:from-[#F2F2F2] sm:from-44% sm:to-[#8C8C8C] sm:drop-shadow-[3px_4px_4px_black] sm:rounded-2xl '
      />
    </>
  );
};
